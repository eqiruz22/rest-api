...
const InsertPerdinDaily = (body, start_date, end_date) => {
    ...
    const value = [body.prj_id, body.user_id, body.title_name, body.maksud_perjalanan, body.tempat_tujuan, start_date, end_date, body.lama_perjalanan, body.transport_tujuan, body.transport_local, body.penginapan, body.meals, body.allowance, body.rapid, body.lain, body.jumlah_advance]
    const query = dbPool.execute(sql, value)
    return query
}
